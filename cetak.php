...
<div class="container">
    ...
    <div class="tanggal">
    <button onclick="displayDate()">Tanggal Input:</button><br><textarea name="" id="demo1" cols="25" rows="1"></textarea>
    </div>
    <div class="kabupaten">
        <label for=""><button>Kabupaten/Kota:</button></label><br>
        <select name="" id="">
            <option value=""></option>
